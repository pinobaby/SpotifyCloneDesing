...
<template>
  <div class="w-60 text-spotify-white h-screen p-2 flex flex-col">
    ...
    <div class="flex-1 space-y-4">
      <div class="space-y-2">
        <div class="w-full bg-spotify-gray rounded-md p-4 text-left">
          <div class="flex">
            <stackIcon class="h-3 w-8 mt-0.5" />
            <spam class="text-xs font-semibold mb-3 -ml-4">Your Library</spam>
          </div>
          <router-link to="/search" class="py-2 flex items-center space-x-2">
          </router-link>
...
<template>
  <div class="sidebar w-60 text-spotify-white h-screen p-2 flex flex-col fixed">
    <div class="mb-2 bg-spotify-gray rounded-md pl-2">
      <nav class="space-y-0">
        <router-link to="/" class="py-2 flex items-center space-x-2">
          <SpotifyLogo class="h-3" />
